            ...
            <div class="card-body p-4">
              <form method="POST">
                ...
                <template v-else-if="ventana==3">
                        ...
                        <div class="card-body">
                          ...
                          <h3>Semanas</h3>
                              <div class="input-group">
                                ...
                                <input type="number" v-model="progreso" class="form-control" min="1" max="100" />
                  ...
                  <div class="form-group row">
                    <label class="col-md-3 form-control-label" for="text-input">Fecha de Estimada de Cumplimiento</label>
                    <div class="col-md-9">
                      <input
                        type="date"
...
export default {
  ...
  methods: {
    ...
    mostrarValor() {
      // let resp=document.getElementsByClassName("progress");
      // console.log(resp);
    },
    cambiarValor(valor)
    {
